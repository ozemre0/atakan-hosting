...
class _IncomeListScreenState extends ConsumerState<IncomeListScreen> {
                        ...
                        if (items.isEmpty)
                          ...
                          ...items.map(
                            (e) => _IncomeItem(
                              ...
                              onDelete: () => _deleteIncome(context, ref, e),
                            ),
                          ),
                      ],
                    ),
  ...
  void _openAddDialog(BuildContext context, WidgetRef ref) {
    IncomeExpenseScreen.openAddIncomeDialog(context, ref, () => setState(() {}));
  }

  void _openEditDialog(BuildContext context, WidgetRef ref, Map<String, dynamic> item) {
    IncomeExpenseScreen.openEditIncomeDialog(context, ref, item, () => setState(() {}));
  }

  Future<void> _deleteIncome(BuildContext context, WidgetRef ref, Map<String, dynamic> item) async {
    final l10n = context.l10n;
    ...
    try {
      ...
      await api.deleteJson('/incomes/$id');
      if (context.mounted) {
